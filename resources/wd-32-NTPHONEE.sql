...
-- Thời gian đã tạo: Th4 06, 2025 lúc 02:36 PM
...
(35, 2, 184, 1, '2025-04-05 07:31:38', '2025-04-05 20:55:20'),
(36, 2, 187, 2, '2025-04-05 11:47:08', '2025-04-05 20:55:00');
...
CREATE TABLE `colors` (
  ...
  `hax_code` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(22, 'G42F45DS5', 'percentage', 1000000, 20.00, 20000000, '2025-04-02', '2025-04-07', '2025-04-04 01:56:32', '2025-04-05 05:04:41');
...
CREATE TABLE `orders` (
  ...
  `status` enum('pending','processing','shipped','delivered','completed','cancelled') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
...
CREATE TABLE `product_images` (
  `id` bigint UNSIGNED NOT NULL,
  `product_id` bigint UNSIGNED NOT NULL,
  `mini_image` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(184, 75, 'Red', '#FF0000', '16GB', 17500000, 16500000, 1, 'active', '2025-04-02 20:18:06', '2025-04-05 00:07:02'),
(185, 75, 'Blue', '#98A7C1', '8GB', 16500000, 15600000, 2, 'active', '2025-04-02 20:18:06', '2025-04-05 00:07:02'),
(186, 75, 'Black', '#1D1D1F', '8GB', 17500000, 16500000, 3, 'active', '2025-04-02 20:18:06', '2025-04-05 00:07:02'),
...
(189, 78, 'Red', '#FF0000', '8GB', 18500000, 16900000, 10, 'active', '2025-04-02 21:34:23', '2025-04-05 08:30:15'),
