...
<head>
    ...
    <title>NTPhone - Cửa hàng Apple chính hãng</title>
    ...
    <meta property="og:site_name" content="Topzone.vn" />
...
/* Hiển thị các phần tử tab-content có class 'active' */
.tab-content.active {
    display: block;
}
...
.tab-button.active {
    ...
    .detail{
        background-color: white;
            ...
            .intro-detail .video-img {
                position: relative
            }

            .intro-detail .slide-sp img {
                display: block;
                margin: auto
            }
            .intro-detail .slide-sp .img-sp {
                width: 80px;
                height: 80px;
                background: #fff;
                border-radius: 8px
            ...
            .intro-detail strong.productstatus {
                color: #ff9f00;
                font-size: 16px;
                display: block;
                margin-bottom: 20px
            ...
            .intro-detail strong.productstatus.atstore {
                font-size: 14px;
                margin-bottom: 15px;
                margin-top: -5px
            }
            ...
            .thubmail-slide .owl-carousel .item-img {
                align-items: center;
                display: flex;
            ...
            .thubmail-slide .owl-carousel .owl-nav button {
                background: url(//cdnv2.tgdd.vn/webmwg/2024/tz/images/next-hover.png) no-repeat center !important;
                height: 50px;
            ...
            .thubmail-slide .owl-carousel .owl-nav button:hover {
                opacity: 1
            }
            ...
            .thubmail-slide .owl-nav button.disabled {
                background: url(//cdnv2.tgdd.vn/webmwg/2024/tz/images/next-hover.png) no-repeat center !important;
                background-size: 50px 50px !important;
                opacity: .3;
            ...
            .thubmail-slide .owl-nav button.disabled:hover {
                background: url(//cdnv2.tgdd.vn/webmwg/2024/tz/images/next-hover.png) no-repeat center !important;
                background-size: 50px 50px !important;
                opacity: .3
            }

            .thubmail-slide .next.disabled,.thubmail-slide .prev.disabled {
                opacity: 0
            }
            ...
            .thubmail-slide.full .next:after {
                right: 5px
            }
            ...
            .thubmail-slide.full .next:before {
                right: 0
            }
            ...
            .price-promo-local span.active:after {
                transform: rotate(-135deg);
                margin: 0 0 0 6px
            }

            .price-promo-local .at-address {
                position: absolute;
                left: 150px;
                top: 25px;
                background: #2f3033;
                ...
                border-radius: 4px;
                display: none;
                box-shadow: 0 0 10px 5px rgba(0,0,0,.21);
                width: 175px
            }

            .price-promo-local .at-address a {
                display: block;
                overflow: hidden;
                padding: 10px 0;
                margin: 0 15px;
            ...
            .price-promo-local .at-address a:last-child {
                border: none
            }

            .price-promo-local .at-address a.active {
                position: relative
            }
            .price-promo-local .at-address a.active:after {
                content: '';
                display: block;
                width: 4px;
                height: 8px;
            ...
            .color-sp ul li.den a {
                background: #312e36
            }

            .color-sp ul li.trang a {
                background: #f5f1ee
            }

            .color-sp ul li.xanhmin a {
                background: #d5eed3
            }

            .color-sp ul li.tim a {
                background: #b0aae3
            }
            ...
            .box-promo .content-promo {
                display: block;
                overflow: hidden;
                margin-bottom: 10px
            }

            .box-promo .content-promo p {
                display: block;
                overflow: hidden;
                font-size: 14px;
                line-height: 21px;
            ...
            .box-promo .content-promo p>span {
                display: inline-block;
                vertical-align: top;
                width: calc(100% - 18px);
                padding: 0
            ...
            .box-promo .content-promo p>span>label {
                display: block;
                margin-top: 10px;
                color: #fff;
                cursor: pointer
            ...
            .box-promo .content-promo p>span>label>em {
                display: inline-block;
                vertical-align: middle;
                width: 16px;
                height: 16px;
            ...
            .box-promo .content-promo p>span>label.active>em {
                border-color: #2997ff
            }

            .box-promo .content-promo p>span>label.active>em:after {
                content: '';
                display: block;
                height: 100%;
            ...
            .box-promo .content-promo p.active:nth-child(n+3) {
                display: block
            }

            .box-promo .content-promo p i {
                display: inline-block;
                vertical-align: top;
                width: 4px;
                height: 4px;
            ...
            .box-promo .content-promo p b em {
                font-style: normal;
                color: #ff9f00
            }

            .box-promo .content-promo p b a {
                display: inline;
                color: #2997ff
            }

            .box-promo .content-promo p b a:after {
                display: none
            }

            .box-promo .content-promo p b span {
                font-weight: normal;
                font-size: 14px;
                line-height: 1.4;
                padding: 3px 0 0 0
            ...
            .box-promo .content-promo p b a.rd-more {
                color: #4a90e2;
                font-size: 13px;
                display: inline-block;
                position: relative;
            ...
            .box-promo .content-promo p b a.rd-more:before {
            ...
            .box-promo .content-promo p>span>label a {
                display: inline;
                color: #2997ff
            }

            .box-promo .content-promo p>span>label a::after {
            ...
            .pr-item .gift .owl-item div.item a {
                cursor: default
            }

            .box-promo.onlinesaving,.box-promo.onlinesavingcms,.box-promo.olgr {
            ...
            .buy-access .bunbled .img-sp img {
                display: block;
                width: 100%
            }

            .buy-access .bunbled h3 {
                display: block;
                overflow: hidden;
                font-size: 15px;
                line-height: 20px;
            ...
            .list-access li.active i {
                background-position: -192px -89px
            }

            .buy-access .total-bill {
                float: right
            }

            .buy-access .total-bill strong {
                display: block;
                overflow: hidden;
                font-size: 20px;
                line-height: 25px;
            ...
            .buy-access .total-bill span em {
                font-style: normal
            }

            .buy-access .total-bill a {
                display: block;
                overflow: hidden;
                width: 289px;
                background: #0071e3;
            ...
            .buy-access .total-bill a.disabled {
                background: #ccc;
                pointer-events: none !important
            }
            ...
            .description .text-detail.expand,.product-review .text-review.expand {
                max-height: 100%
            }
            ...
            .access-sg>div.item:nth-child(n+5) {
                display: none
            }

            .access-sg div.item:last-child {
                margin-right: 0
            }

            .access-sg div.item a {
                display: block;
                overflow: hidden
            }
            ...
            .access-sg.owl-carousel .owl-nav button {
                opacity: .3
            }

            .access-sg.owl-carousel .owl-nav button:hover {
                opacity: .7
            }

            .access-sg.owl-carousel .owl-nav button.owl-next {
                right: 0
            }

            .access-sg.owl-carousel .owl-nav button.owl-prev {
                left: 0
            }

            .access-sg.owl-carousel .owl-nav button.disabled {
                display: none
            }

            .access-needbuy .an-title>* {
                display: inline-block;
                vertical-align: top
            }

            .access-needbuy .an-title>div {
                position: relative
            }

            .access-needbuy .an-title>div i {
                font-style: normal;
                width: 16px;
                height: 16px;
                border-radius: 50%;
            ...
            .access-needbuy .an-title>div i.active:before {
                content: "";
                position: absolute;
                width: 12px;
                height: 12px;
            ...
            .access-needbuy .an-title>div span {
                position: absolute;
                width: 300px;
                padding: 7px 10px;
            ...
            .list-store .close:before,.list-store .close:after {
                content: '';
                width: 12px;
                height: 2px;
                background: #000;
            ...
            .list-store .close:after {
                transform: rotate(-45deg)
            }

            .list-store .tab-store {
                display: block;
                text-align: center
            }

            .list-store .tab-store .tab-id {
                display: inline-block;
                vertical-align: middle;
                padding: 0 10px 10px;
                border-bottom: 1px solid #e5e5e5;
            ...
            .list-store .tab-store .tab-id:last-child {
                margin-left: -4px
            }

            .list-store .tab-store .tab-id.current {
                color: #101010;
                border-bottom: 1px solid #101010;
                font-weight: 500
            }

            .list-store .tab-store div {
                position: relative;
                width: 235px;
                display: inline-block;
                vertical-align: top
            ...
            .list-store .tab-store div.ts-province {
                margin-right: 5px
            }

            .list-store .tab-store div span {
                border: 1px solid #e5e5e5;
                border-radius: 12px;
                background-color: #fff;
                display: block;
            ...
            .list-store .tab-store div span:before {
                content: '';
            ...
            .list-store .tab-store div span.active:before {
                transform: rotate(-45deg);
                top: 4px
            }

            .list-store .tab-store div ul {
                position: absolute;
                left: 0;
                top: 55px;
            ...
            .list-store .tab-store div ul:before {
                content: "";
                position: absolute;
                width: 27px;
                height: 27px;
            ...
            .list-store .tab-store div ul li {
                cursor: pointer;
                padding-top: 15px;
                position: relative;
                z-index: 1;
            ...
            .tab-box li .info-store {
                display: inline-block;
                vertical-align: middle;
                width: 75%
            }

            .tab-box li .info-store strong {
                display: block;
                overflow: hidden;
                color: #3a3a3a;
                font-size: 15px;
            ...
            .tab-box li .info-store i {
                display: inline-block;
                vertical-align: middle;
                margin: 0 5px 0 0
            }

            .tab-box li .info-store .sold-out {
                color: #101010
            }
            ...
            .text-detail .bg-article,.text-review .bg-review {
            ...
            .short .text-detail .btn-detail,.short .text-detail .bg-article,.short .text-review .btn-review,.short .text-review .bg-review {
                display: block
            }
            ...
            .block-sign .bs-form input:focus {
                background-color: #000
            }
            ...
            .block-sign .bs-form label.s-fullname {
                float: left;
                margin-left: 16px
            }

            .block-sign .bs-form label.s-phone {
                float: right;
                margin-right: 16px
            }
            ...
            #popup-customer .pc-list::-webkit-scrollbar {
                width: 10px;
                border-radius: 10px;
                background-color: #eee
            }

            #popup-customer .pc-list::-webkit-scrollbar-thumb {
                border-radius: 10px;
                background-color: #ccc
            }
            ...
            .tzmd .grprodinfo .img img {
                width: 80px;
                height: auto
            }

            .tzmd .grprodinfo .name {
                flex: 1
            }

            .tzmd .grprodinfo .name .pname {
                font-size: 15px;
                line-height: 20px;
                color: #323232;
                flex: none;
            ...
            .tzmd .grprodinfo .name .pcolor .cl757575 {
                color: #757575
            }

            .tzmd .grprodinfo .grprice {
                font-weight: bold;
                font-size: 15px;
                line-height: 20px;
                text-align: right;
            ...
            .tzmd .grprodinfo .grprice strike {
                display: block;
                font-weight: normal;
                font-size: 14px;
                line-height: 21px;
            ...
            .tzmd .grinscompany .lstcomp {
                display: grid;
                grid-template-columns: 1fr 1fr 1fr 1fr;
                grid-gap: 10px
            }

            .tzmd .grinscompany .lstcomp .bxlognh {
                background: #fff;
                border: 1px solid #e5e5e5;
            ...
            .tzmd .grinscompany .lstcomp .bxlognh.active {
                border-color: #0071e3
            }

            .tzmd .grinscompany .lstcomp input[type=radio] {
            ...
            .tzmd .grinscompany .lstcomp label {
                flex: 1;
            ...
            .tzmd .grinscompany .icoins {
                background: url(/images/Installment/sprite_ins.png);
                width: 77px;
                height: 24px;
                display: block
            }

            .tzmd .grinscompany .icoins.icoins-ACS {
                background-position: -10px -10px
            }

            .tzmd .grinscompany .icoins.icoins-MC {
                background-position: -10px -56px
            }

            .tzmd .grinscompany .icoins.icoins-FE {
                background-position: -107px -10px
            }
            .tzmd .grinscompany .icoins.icoins-HC {
            ...
            .tzmd .sex input[type=radio]:checked+label>.box {
                border: 1px solid #000
            }

            .tzmd .sex input[type=radio]:checked+label>.box:before {
                content: '';
                background-color: #000;
                width: 8px;
                height: 8px;
            ...
            .buy-sp .btn-ins.pay-taichinh,.buy-sp .btn-ins.pay-nganluong {
                float: left;
                color: #101010;
                background: #fff;
                font-size: 16px;
            ...
            .buy-sp .btn-ins.pay-taichinh.blue,.buy-sp .btn-ins.pay-nganluong.blue {
                background-color: #0071e3;
                color: #fff;
                padding: 8px 0 12px 0
            }

            .buy-sp .btn-ins.pay-taichinh {
                float: left
            }

            .buy-sp .btn-ins.pay-nganluong {
                float: right;
                margin-right: 0
            }

            .buy-sp .btn-buy.disable {
            ...
            .buy-sp .btn-ins.has-another-pay {
                width: 49%
            }
            ...
            .store-province .SearchContainer {
            ...
            .store-province .SearchContainer input#SearchProvince {
                width: 100%;
                border: none
            }
            ...
            .store-province ul li.Item {
                padding: 10px;
                border: 1px solid transparent;
                border-radius: 8px
            }

            .store-province ul li.Item a {
                color: #101010
            }

            .store-province ul li.Item.active {
                background-color: #0071e3
            }

            .store-province ul li.Item.active a {
                color: #fff
            }

            .SearchContainer .topzone-search {
                display: block;
                margin: 2px auto
            }
            ...
            .SearchContainer .topzone-search {
                ...
                width: 20px;
                height: 20px;
                background-image: url(//cdnv2.tgdd.vn/webmwg/2024/tz/images/mobile/Icon-topzone.png);
            ...
            .Provinces::-webkit-scrollbar {
                width: 3px;
                height: 0
            }

            .Provinces::-webkit-scrollbar-thumb {
                background: #888
            }
            ...
            .box_saving .bs_content p.text {
                color: #fff;
                margin-bottom: 10px;
                line-height: 1.4
            }

            .box_saving .bs_content p.text em {
                font-style: normal
            }
            ...
            .box_saving .buy-sp a.red {
                background-color: #d43232;
                font-size: 16px;
                margin-right: 10px
            }

            .box_saving .buy-sp a.red.full {
                margin-right: 0
            }

            .box_saving .buy-sp a.red span {
                display: block;
                font-weight: normal;
                font-size: 12px;
                line-height: 1.1
            ...
            .box_cleanstock .box-promo.cleanstock {
                padding: 0;
                margin-bottom: 0;
                background-color: transparent
            }

            .box_cleanstock .box-promo.cleanstock span,.box_cleanstock .box-promo.cleanstock small,.box_cleanstock .box-promo.cleanstock .content-promo p {
                color: #333
            }

            .box_cleanstock .box-promo.cleanstock .content-promo p i {
                background-color: #333
            }

            .box_cleanstock .buy-sp {
                display: block !important;
                overflow: hidden;
                margin-bottom: 10px
            }

            .box_cleanstock .buy-sp a.red {
                background-color: #d43232;
                margin-right: 10px
            }

            .box_cleanstock .buy-sp a.red.full {
                margin-right: 0
            }

            .box_cleanstock .buy-sp a.red span {
                display: block;
                font-weight: normal;
                font-size: 12px;
                line-height: 1.1
            ...
            .box_cleanstock .box-promo .content-promo p>span>label,.box_cleanstock .pr-item.img>p,.box_cleanstock .pr-item .gift .title-lh p {
                color: #333
            }

            .box_cleanstock .promotion-choose {
                margin-top: 1px
            }

            .box_cleanstock .box-promo p.text {
                color: #f01
            }

            .box_cleanstock .pr-item .gift .owl-item div.item {
                background-color: #fff
            }

            .box_cleanstock .box-promo .content-promo p b strong {
                color: #f01
            }
            ...
            .img-access-sg .lazyload {
                opacity: 0
            }

            .img-access-sg .lazyloaded {
                opacity: 1
            }
            ...
            .same-product .product-sg {
                display: block;
                margin: 16px 0 20px
            }

            .same-product .product-sg div.item {
                float: left;
                width: 180px;
                height: 320px;
                margin-right: 20px;
            ...
            .same-product .product-sg div.item a {
                display: block;
                overflow: hidden;
                color: #fff
            }

            .same-product .product-sg div.item .img-product-sg {
                display: block;
                overflow: hidden;
                width: 170px;
                height: 170px;
            ...
            .same-product .product-sg div.item .img-product-sg img {
                display: block;
                width: 100%
            }

            .same-product .product-sg div.item .img-product-sg.category-nav {
                display: block;
                position: relative;
                width: 56px;
                height: 56px;
            ...
            .same-product .product-sg div.item .img-product-sg.category-nav i.topzone-category-nav {
                background-position: -881px -14px;
                width: 50px;
                height: 50px;
                background-size: 1028px 454px;
                filter: brightness(0) invert(1)
            }

            .same-product .product-sg div.item h3 {
                display: block;
                overflow: hidden;
                color: #fff;
                font-size: 15px;
            ...
            .same-product .product-sg div.item span b {
                display: block;
                font-size: 18px;
                font-weight: 700;
                line-height: 23px;
            ...
            .same-product .product-sg div.item span {
                font-size: 15px
            }

            .same-product .owl-carousel .owl-nav button.owl-prev {
                left: -25px
            }

            .same-product .owl-carousel .owl-nav button.owl-next {
                right: -25px
            }
            ...
            .product__coupon form span.outCoupon.error {
                display: block !important
            }
            ...
            .product__coupon form span._\5ftitle {
            ...
            .product__coupon form span span {
                text-decoration: initial;
                color: #333
            }
            ...
            .product-review ul,.product-review li {
                font-size: 16px;
                line-height: 24px
            }
            ...
            .product-review table ul,.product-review table li {
        ...
        @keyframes lds-roller{0%{transform:rotate(0deg)}100%{transform:rotate(360deg)}}[class^="boxchat-"],
        [class*="boxchat-"] {
        ...
        * {
        ...
        h6 a {
            ...
            [class*="topzone-"] {
                ...
                background-size:514px 226px}[class^="iconlogo-"],
                [class*="iconlogo-"] {
                ...
                .iconlogo-erablue {
                    ...
                    background-position:-145px -150px}[class^="iconsocial-"],
                    [class*="iconsocial-"] {
                    ...
                    .topzone-logo.christmas {
                        background: url(//cdnv2.tgdd.vn/webmwg/2024/tz/images/christmas/desktop/logo_topzone.png?v=1) no-repeat;
                        background-size: auto 100%;
                    ...
                    .topzone-autho.christmas {
                        background: url(//cdnv2.tgdd.vn/webmwg/2024/tz/images/christmas/desktop/Logo_Apple.png) no-repeat;
                        background-size: 100%;
                        background-position: center;
                        width: 32px;
                        height: 40px
                    ...
                    .theme-newyear .topzone-logo {
                        background: url(//cdnv2.tgdd.vn/webmwg/2024/tz/images/newyear/2025/duong/logo-desktop-v2.png) no-repeat;
                        background-size: auto 100%;
                    ...
                    .theme-lunaryear .topzone-logo {
                        background: url(//cdnv2.tgdd.vn/webmwg/2024/tz/images/newyear/2025/am/logo-desktop-v2.png) no-repeat;
                        background-size: auto 100%;
                        background-position: right;
                        width: 111px;
                        height: 35px
                    ...
                    .theme-national .topzone-logo {
                        background-image: url("//cdnv2.tgdd.vn/webmwg/2024/tz/images/holiday29/logo-holiday-dt.png");
                        background-repeat: no-repeat;
                    ...
                    .popup-banner .only-banner img {
                        cursor: pointer;
                        width: 320px;
                        height: 360px
                    }

                    .popup-banner .icon-close-popup {
                        display: block;
                        position: absolute;
                        width: 25px;
                        height: 25px;
                    ...
                    .popup-banner .icon-close-popup::after {
                        position: absolute;
                        content: "";
                        width: 13px;
                        height: 1.5px;
                    ...
                    .popup-banner .icon-close-popup::before {
                        position: absolute;
                        content: "";
                        width: 13px;
                        height: 1.5px;
                    ...
                    .topzone-homeDiver.christmas {
                        background: url(//cdnv2.tgdd.vn/webmwg/2024/tz/images/christmas/desktop/policy_homeDiver.png) no-repeat;
                        width: 56px;
                        height: 56px;
                        background-size: auto 100%
                    }
                    ...
                    .topzone-homeDeli.christmas {
                        background: url(//cdnv2.tgdd.vn/webmwg/2024/tz/images/christmas/desktop/policy_homeDeli.png) no-repeat;
                        width: 56px;
                        height: 56px;
                        background-size: auto 100%
                    }
                    ...
                    .topzone-homeInsur.christmas {
                        background: url(//cdnv2.tgdd.vn/webmwg/2024/tz/images/christmas/desktop/policy_homeInsur.png) no-repeat;
                        width: 56px;
                        height: 56px;
                        background-size: auto 100%
                    }
                    ...
                    .topzone-homeReturn.christmas {
                        background: url(//cdnv2.tgdd.vn/webmwg/2024/tz/images/christmas/desktop/policy_homeReturn.png) no-repeat;
                        width: 56px;
                        height: 56px;
                        background-size: auto 100%
                    }
                    ...
                    .choose-cate.christmas li {
                        background: url(//cdnv2.tgdd.vn/webmwg/2024/tz/images/christmas/desktop/Desk_BackgroundMenuCate.png);
                        background-size: 100%;
                        background-repeat: no-repeat
                    }

                    .logo-cate.cate-christmas {
                        background: url(//cdnv2.tgdd.vn/webmwg/2024/tz/images/christmas/desktop/Desk_Tagline.png);
                        width: 380px;
                        height: 95px;
                    ...
                    .box-slide .news-christmas {
                        background: url(//cdnv2.tgdd.vn/webmwg/2024/tz/images/christmas/desktop/Tagline_Tekzone.png);
                        background-size: 100%;
                        width: 374px;
                        height: 95px;
                        background-repeat: no-repeat;
                    ...
                    .flashsale-block.fs-christmas {
                        margin-top: 70px;
                        position: relative
                    }

                    .flashsale-block.fs-christmas::before {
                        background: url("//cdnv2.tgdd.vn/webmwg/2024/tz/images/christmas/desktop/icon-fs.png") no-repeat;
                        background-size: 100%;
                        content: "";
                        height: 72px;
                        position: absolute;
                    ...
                    .fs-christmas .gvdshock h3 {
                        background: url("//cdnv2.tgdd.vn/webmwg/2024/tz/images/christmas/desktop/title-fs.png") no-repeat;
                        background-size: 486px 102px
                    }

                    .theme-noel .main {
                        background: url("//cdnv2.tgdd.vn/webmwg/2024/tz/images/christmas/desktop/BG.png") repeat-y;
                        background-size: 100%;
                        padding-top: 70px
                    }

                    .theme-noel .flashsale-block.fs-christmas {
                        margin-top: 0
                    }
                    ...
                    .body-theme-newyear {
                        background: #3e3e3f url("//cdnv2.tgdd.vn/webmwg/2024/tz/images/newyear/2025/duong/bg-main.png") no-repeat;
                        background-size: 100%;
                        background-attachment: fixed;
                        background-position: center bottom
                    }

                    .body-theme-newyear .choose-cate li {
                        background: url("//cdnv2.tgdd.vn/webmwg/2024/tz/images/newyear/2025/duong/bg-menu-dt.png") no-repeat;
                    ...
                    .body-theme-newyear .gvdshock h3 img {
                        display: none
                    }

                    .body-theme-newyear .gvdshock h3 i {
                        background: url("//cdnv2.tgdd.vn/webmwg/2024/tz/images/newyear/2025/duong/title-flashsale.png") no-repeat;
                        background-size: 100%;
                        background-position: center bottom;
                        height: 102px;
                        width: 486px
                    ...
                    .body-theme-newyear .logo-cate {
                        background: url("//cdnv2.tgdd.vn/webmwg/2024/tz/images/newyear/2025/duong/bg-tagline.png") no-repeat;
                        background-size: 360px 94px;
                        width: 360px;
                        height: 94px;
                        justify-content: center;
                        background-repeat: no-repeat;
                    ...
                    .body-theme-newyear .logo-cate i {
                        margin: 0 !important
                    }

                    .body-theme-newyear a.logo-cate h2 {
                        color: #333
                    }

                    .body-theme-newyear .box-slide .logo-cate i.topzone-iconapple {
                        background: url(//cdnv2.tgdd.vn/webmwg/2024/tz/images/newyear/2025/duong/icon-apple-black.png) no-repeat;
                        background-size: 100%;
                        height: 32px;
                        width: 26px
                    }

                    .body-theme-newyear .topzone-homeDiver {
                        background: url(//cdnv2.tgdd.vn/webmwg/2024/tz/images/newyear/2025/duong/policy_homeDiver.png) no-repeat;
                        width: 56px;
                        height: 56px;
                        background-size: auto 100%
                    }

                    .body-theme-newyear .topzone-homeDeli {
                        background: url(//cdnv2.tgdd.vn/webmwg/2024/tz/images/newyear/2025/duong/policy_homeDeli.png) no-repeat;
                        width: 56px;
                        height: 56px;
                        background-size: auto 100%
                    }

                    .body-theme-newyear .topzone-homeInsur {
                        background: url(//cdnv2.tgdd.vn/webmwg/2024/tz/images/newyear/2025/duong/policy_homeInsur.png) no-repeat;
                        width: 56px;
                        height: 56px;
                        background-size: auto 100%
                    }

                    .body-theme-newyear .topzone-homeReturn {
                        background: url(//cdnv2.tgdd.vn/webmwg/2024/tz/images/newyear/2025/duong/policy_homeReturn.png) no-repeat;
                        width: 56px;
                        height: 56px;
                        background-size: auto 100%
                    }

                    .body-theme-newyear .slide-home.owl-carousel {
                        z-index: 2
                    }
                    ...
                    .body-theme-lunaryear {
                        background: #3e3e3f url("//cdnv2.tgdd.vn/webmwg/2024/tz/images/newyear/2025/am/bg-main.png") no-repeat;
                        background-size: 100%;
                        background-attachment: fixed;
                        background-position: center bottom
                    }

                    .body-theme-lunaryear .choose-cate li {
                        background: url("//cdnv2.tgdd.vn/webmwg/2024/tz/images/newyear/2025/am/bg-menu-dt.png") no-repeat;
                        background-size: 100% 100%
                    }

                    .body-theme-lunaryear .label-left,
                    .body-theme-lunaryear .label-right {
                        bottom: 0;
                        position: fixed;
                        z-index: 1
                    }
                    ...
                    .body-theme-lunaryear .gvdshock h3 img {
                        display: none
                    }

                    .body-theme-lunaryear .gvdshock h3 i {
                        background: url("//cdnv2.tgdd.vn/webmwg/2024/tz/images/newyear/2025/am/title-flashsale.png") no-repeat;
                        background-size: 100%;
                        background-position: center bottom;
                        height: 102px;
                        width: 486px
                    ...
                    .body-theme-lunaryear .box-slide .logo-cate i {
                        height: 94px;
                        width: 369px
                    }

                    .body-theme-lunaryear .box-slide .logo-cate i.topzone-cateiphone {
                        background-image: url(//cdnv2.tgdd.vn/webmwg/2024/tz/images/newyear/2025/am/tagline-iphone-dt.png);
                        background-repeat: no-repeat;
                        background-size: 100%;
                        background-position: unset
                    }

                    .body-theme-lunaryear .box-slide .logo-cate i.topzone-catemac {
                        background-image: url(//cdnv2.tgdd.vn/webmwg/2024/tz/images/newyear/2025/am/tagline-mac-dt.png);
                        background-repeat: no-repeat;
                        background-size: 100%;
                        background-position: unset
                    }

                    .body-theme-lunaryear .box-slide .logo-cate i.topzone-cateipad {
                        background-image: url(//cdnv2.tgdd.vn/webmwg/2024/tz/images/newyear/2025/am/tagline-ipad-dt.png);
                        background-repeat: no-repeat;
                        background-size: 100%;
                        background-position: unset
                    }

                    .body-theme-lunaryear .box-slide .logo-cate i.topzone-catewatch {
                        background-image: url(//cdnv2.tgdd.vn/webmwg/2024/tz/images/newyear/2025/am/tagline-watch-dt.png);
                        background-repeat: no-repeat;
                        background-size: 100%;
                        background-position: unset
                    }

                    .body-theme-lunaryear .box-slide .logo-cate i.topzone-amthanh {
                        background-image: url(//cdnv2.tgdd.vn/webmwg/2024/tz/images/newyear/2025/am/tagline-amthanh-dt.png);
                        background-repeat: no-repeat;
                        background-size: 100%;
                        background-position: unset
                    }

                    .body-theme-lunaryear .box-slide .logo-cate i.topzone-phukien {
                        background-image: url(//cdnv2.tgdd.vn/webmwg/2024/tz/images/newyear/2025/am/tagline-phukien-dt.png);
                        background-repeat: no-repeat;
                        background-size: 100%;
                        background-position: unset
                    }

                    .body-theme-lunaryear .box-slide .logo-cate i.topzone-tekzone {
                        background-image: url(//cdnv2.tgdd.vn/webmwg/2024/tz/images/newyear/2025/am/tagline-tekzone-dt.png);
                        background-repeat: no-repeat;
                        background-size: 100%;
                        background-position: unset
                    }

                    .body-theme-lunaryear a.logo-cate h2 {
                        display: none
                    }

                    .body-theme-lunaryear .topzone-homeDiver {
                        background: url(//cdnv2.tgdd.vn/webmwg/2024/tz/images/newyear/2025/am/policy_homeDiver.png) no-repeat;
                        width: 56px;
                        height: 56px;
                        background-size: auto 100%
                    }

                    .body-theme-lunaryear .topzone-homeDeli {
                        background: url(//cdnv2.tgdd.vn/webmwg/2024/tz/images/newyear/2025/am/policy_homeDeli.png) no-repeat;
                        width: 56px;
                        height: 56px;
                        background-size: auto 100%
                    }

                    .body-theme-lunaryear .topzone-homeInsur {
                        background: url(//cdnv2.tgdd.vn/webmwg/2024/tz/images/newyear/2025/am/policy_homeInsur.png) no-repeat;
                        width: 56px;
                        height: 56px;
                        background-size: auto 100%
                    }

                    .body-theme-lunaryear .topzone-homeReturn {
                        background: url(//cdnv2.tgdd.vn/webmwg/2024/tz/images/newyear/2025/am/policy_homeReturn.png) no-repeat;
                        width: 56px;
                        height: 56px;
                        background-size: auto 100%
                    }

                    .body-theme-lunaryear .slide-home.owl-carousel {
                        z-index: 2
                    }
            ...
            <div class="search-cart">
                ...
                <div class="cart">
                    ...
                    <div
                        ...
                        <a href="{{ route('customer.profile') }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Thông tin cá
                            nhân</a>
