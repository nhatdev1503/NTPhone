...
<a href="#" class="backtop" title="Lên đầu trang">
    <svg style="margin: auto;" aria-hidden="true" focusable="false" data-prefix="far" data-icon="angle-up" role="img"
...
<div class="addThis_iconContact">
	<div class="box-item item-contact">
		<div class="svgico">
			<svg style="width: 34px; height: 35px; margin:auto" viewBox="0 0 34 35" xmlns="http://www.w3.org/2000/svg">
				<path
