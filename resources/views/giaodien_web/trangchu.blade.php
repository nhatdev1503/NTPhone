    ...
    @yield('content')
        ...
        <div class="bodywrap">
            ...
            <section class="section_slider">
                <div class="home-slider swiper-container">
                    <div class="swiper-wrapper">
                        ...
                        <a href="https://www.hoangkien.com/cam-ket-chat-luong" title="Slider"
                            class="swiper-slide">
                            <picture>
                                <source media="(min-width: 1200px)"
                        ...
                        <a href="https://www.hoangkien.com/chinh-sach-mua-lai" title="Slider"
                            class="swiper-slide">
                            <picture>
                                <source media="(min-width: 1200px)"
                    ...
                    <div class="container">
                        <div class="row row-fix">
                            <div class="col-md-6 col-6 col-fix margin-0">
                                <a class="thumb-image-banner"
                                    href="https://www.hoangkien.com/chinh-sach-doi-tra-len-doi" title="Banner">
                                    <picture>
                ...
                <div class="container">
                    <div class="block-background">
                        <h3 class="title-index p-5">
                            <a class="title-name" href="/collections/all" title="Danh mục nổi bật">Danh mục nổi
                                bật
                            </a>
                        </h3>
                            ...
                            <div class="swiper-wrapper">
                                    ...
                                    <div class="row row-fix">
                                        <div class="col-12 item col-fix">
                                            <div class="product-image">
                                                <a class="image_thumb scale_hover" href="/dien-thoai"
                                                    title="iPhone 16 Pro Max 256GB">
                                                    <picture>

                                                        <source media="(max-width: 567px)"
                                                            srcset="https://bizweb.dktcdn.net/100/112/815/products/16prm-full-da134920-b18f-41e8-a5c9-50312d7d0e9d-b975b0aa-7752-49b5-abab-233be70b7b70.png?v=1730447628487">
                                ...
                                <div class="swiper-slide">
                                    <div class="row row-fix">
                                        <div class="col-12 item col-fix">
                                            <div class="product-image">
                                                <a class="image_thumb scale_hover" href="/phu-kien"
                                                    ...
                                                    <picture>
                                                        ...
                                                        <img width="130" height="130"
                                                            src="https://bizweb.dktcdn.net/100/112/815/products/ytrtyi.png?v=1703319792653"
                                ...
                                <div class="swiper-slide">
                                    <div class="row row-fix">
                                        <div class="col-12 item col-fix">
                                            <div class="product-image">
                                                <a class="image_thumb scale_hover" href="/pin-eu-dung-luong-cao"
                                                    ...
                                                    <picture>
                                                        ...
                                                        <img width="130" height="130"
                                                            src="https://bizweb.dktcdn.net/100/112/815/products/987b7279884f23117a5e-46e16906-df66-4993-bdfe-66e039f3fd55.jpg?v=1729321804880"
                                ...
                                <div class="swiper-slide">
                                    <div class="row row-fix">
                                        <div class="col-12 item col-fix">
                                            <div class="product-image">
                                                <a class="image_thumb scale_hover" href="/pin-eu"
                                                    title="Pin EU iPhone 14 PRO MAX">
                                                    <picture>
                                                        ...
                                                        <img width="130" height="130"
                                                            src="https://bizweb.dktcdn.net/100/112/815/products/987b7279884f23117a5e-0e3a87fc-0b54-4da9-bf81-606f5793c0fa-9b74d55e-fc69-4a38-9d33-19730b2a4430.jpg?v=1728285489953"
            ...
            <section class="section_1_banner">
                <div class="container">
                    <a class="thumb-image-banner"
                        href="https://www.hoangkien.com/chinh-sach-bao-hanh-12-thang-1-doi-1" title="Banner">
                        <img width="1270" height="236" class="lazyload"
                            src="//bizweb.dktcdn.net/100/112/815/themes/966034/assets/lazy.png?1741067950025"
                                ...
                                <div class="product2-swiper swiper-container p-5">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide swiper-slide-pro">
                                            ...
                                            <form action="/cart/add" method="post"
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <h3 class="product-name"><a class="line-clamp line-clamp-2"
                                                            href="/cap-type-c-type-c-1m-iphone-chinh-hang"
                                                            title="Cáp Sạc Nhanh C To C 1m iPhone Zin">Cáp Sạc Nhanh C
                                                            To C 1m iPhone Zin</a></h3>
                                                    <div class="price-box">
                                                        250.000₫
                                        ...
                                        <div class="swiper-slide swiper-slide-pro">
                                            ...
                                            <form action="/cart/add" method="post"
                                                class="variants product-action" data-cart-form
                                                data-id="product-actions-21162027" enctype="multipart/form-data">
                                                <div class="product-thumbnail">
                                                    <a class="image_thumb scale_hover"
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <h3 class="product-name"><a class="line-clamp line-clamp-2"
                                                            href="/sac-nhanh-20w-iphone-chinh-hang-pro-max"
                                                            title="Sạc Nhanh 20W iPhone chính hãng">Sạc Nhanh 20W
                                                            iPhone chính hãng</a></h3>
                                                    <div class="price-box">
                                                        350.000₫
                                        ...
                                        <div class="swiper-slide swiper-slide-pro">
                                            ...
                                            <form action="/cart/add" method="post"
                                                class="variants product-action" data-cart-form
                                                data-id="product-actions-17750021" enctype="multipart/form-data">
                                                <div class="product-thumbnail">
                                                    <a class="image_thumb scale_hover"
                                        ...
                                        <div class="swiper-slide swiper-slide-pro">
                                            ...
                                            <form action="/cart/add" method="post"
                                                class="variants product-action" data-cart-form
                                                data-id="product-actions-17750018" enctype="multipart/form-data">
                                                <div class="product-thumbnail">
                                                    <a class="image_thumb scale_hover"
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <h3 class="product-name"><a class="line-clamp line-clamp-2"
                                                            href="/cap-sac-nhanh-iphone-chinh-hang-pro-max"
                                                            title="Cáp Sạc Nhanh C To L iPhone Zin">Cáp Sạc Nhanh C To
                                                            L iPhone Zin</a></h3>
                                                    <div class="price-box">
                                                        200.000₫
                                        ...
                                        <div class="swiper-slide swiper-slide-pro">
                                            ...
                                            <form action="/cart/add" method="post"
                                                class="variants product-action" data-cart-form
                                                data-id="product-actions-3990425" enctype="multipart/form-data">
                                                <div class="product-thumbnail">
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <h3 class="product-name"><a class="line-clamp line-clamp-2"
                                                            ...
                                                            title="Cáp iPhone USB to L Zin">Cáp iPhone USB to L
                                                            Zin</a></h3>
                                                    <div class="price-box">
                                                        150.000₫
                                    ...
                                    <div class="text-center no-padding">
                                        <a class="see-more" title="Xem toàn bộ sản phẩm" href="phu-kien">Xem toàn
                ...
                <div class="container">
                    <div class="block-background">
                        ...
                        <div class="product4-swiper swiper-container p-5">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide swiper-slide-pro">
                                    ...
                                    <form action="/cart/add" method="post" class="variants product-action"
                                        data-cart-form data-id="product-actions-37786664"
                                        ...
                                        <div class="product-info">
                                            ...
                                            <h3 class="product-name"><a class="line-clamp line-clamp-2"
                                                    href="/pin-eu-iphone-12-pro-max-dung-luong-cao"
                                                    title="Pin EU iPhone 12 PRO MAX Dung Lượng Cao">Pin EU iPhone 12
                                                    PRO MAX Dung Lượng Cao</a></h3>
                                            <div class="price-box">
                                                800.000₫
                                ...
                                <div class="swiper-slide swiper-slide-pro">
                                    ...
                                    <form action="/cart/add" method="post" class="variants product-action"
                                        data-cart-form data-id="product-actions-37786679"
                                        enctype="multipart/form-data">
                                        <div class="product-thumbnail">
                                            <a class="image_thumb scale_hover"
                                        ...
                                        <div class="product-info">
                                            ...
                                            <h3 class="product-name"><a class="line-clamp line-clamp-2"
                                                    href="/pin-eu-iphone-12-pro-dung-luong-cao"
                                                    title="Pin EU iPhone 12 PRO Dung Lượng Cao">Pin EU iPhone 12 PRO
                                                    Dung Lượng Cao</a></h3>
                                            <div class="price-box">
                                                650.000₫
                                ...
                                <div class="swiper-slide swiper-slide-pro">
                                    ...
                                    <form action="/cart/add" method="post" class="variants product-action"
                                        data-cart-form data-id="product-actions-37786691"
                                        enctype="multipart/form-data">
                                        <div class="product-thumbnail">
                                            <a class="image_thumb scale_hover"
                                ...
                                <div class="swiper-slide swiper-slide-pro">
                                    ...
                                    <form action="/cart/add" method="post" class="variants product-action"
                                        data-cart-form data-id="product-actions-37786704"
                                        enctype="multipart/form-data">
                                        <div class="product-thumbnail">
                                            <a class="image_thumb scale_hover"
                                        ...
                                        <div class="product-info">
                                            ...
                                            <h3 class="product-name"><a class="line-clamp line-clamp-2"
                                                    href="/pin-eu-iphone-11-pro-max-dung-luong-cao"
                                                    title="Pin EU iPhone 11 PRO MAX Dung Lượng Cao">Pin EU iPhone 11
                                                    PRO MAX Dung Lượng Cao</a></h3>
                                            <div class="price-box">
                                                750.000₫
                                ...
                                <div class="swiper-slide swiper-slide-pro">
                                    ...
                                    <form action="/cart/add" method="post" class="variants product-action"
                                        data-cart-form data-id="product-actions-37786709"
                                        enctype="multipart/form-data">
                                        <div class="product-thumbnail">
                                            <a class="image_thumb scale_hover"
                                        ...
                                        <div class="product-info">
                                            ...
                                            <h3 class="product-name"><a class="line-clamp line-clamp-2"
                                                    href="/pin-eu-iphone-11-pro-dung-luong-cao"
                                                    title="Pin EU iPhone 11 PRO Dung Lượng Cao">Pin EU iPhone 11 PRO
                                                    Dung Lượng Cao</a></h3>
                                            <div class="price-box">
                                                700.000₫
                                ...
                                <div class="swiper-slide swiper-slide-pro">
                                    ...
                                    <form action="/cart/add" method="post" class="variants product-action"
                                        data-cart-form data-id="product-actions-37786722"
                                        enctype="multipart/form-data">
                                        <div class="product-thumbnail">
                                            <a class="image_thumb scale_hover"
                                ...
                                <div class="swiper-slide swiper-slide-pro">
                                    ...
                                    <form action="/cart/add" method="post" class="variants product-action"
                                        data-cart-form data-id="product-actions-37786728"
                                        enctype="multipart/form-data">
                                        <div class="product-thumbnail">
                                            <a class="image_thumb scale_hover"
                                        ...
                                        <div class="product-info">
                                            ...
                                            <h3 class="product-name"><a class="line-clamp line-clamp-2"
                                                    href="/pin-eu-iphone-xs-max-dung-luong-cao"
                                                    title="Pin EU iPhone XS MAX Dung Lượng Cao">Pin EU iPhone XS MAX
                                                    Dung Lượng Cao</a></h3>
                                            <div class="price-box">
                                                700.000₫
                                ...
                                <div class="swiper-slide swiper-slide-pro">
                                    ...
                                    <form action="/cart/add" method="post" class="variants product-action"
                                        data-cart-form data-id="product-actions-37786735"
                                        enctype="multipart/form-data">
                                        <div class="product-thumbnail">
                                            <a class="image_thumb scale_hover"
                                ...
                                <div class="swiper-slide swiper-slide-pro">
                                    ...
                                    <form action="/cart/add" method="post" class="variants product-action"
                                        data-cart-form data-id="product-actions-37786747"
                                        enctype="multipart/form-data">
                                        <div class="product-thumbnail">
                                            <a class="image_thumb scale_hover"
                            ...
                            <div class="text-center no-padding">
                                <a class="see-more" title="Xem toàn bộ sản phẩm" href="pin-eu-dung-luong-cao">Xem
                                    toàn bộ sản phẩm <svg xmlns="http://www.w3.org/2000/svg" height="1em"
                                        viewBox="0 0 448 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                        <path
                                            d="M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z" />
                                ...
                                <div class="product3-swiper swiper-container p-5">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide swiper-slide-pro">
                                            ...
                                            <form action="/cart/add" method="post"
                                                class="variants product-action" data-cart-form
                                                data-id="product-actions-32473076" enctype="multipart/form-data">
                                                <div class="product-thumbnail">
                                                    <a class="image_thumb scale_hover"
                                        ...
                                        <div class="swiper-slide swiper-slide-pro">
                                            ...
                                            <form action="/cart/add" method="post"
                                                class="variants product-action" data-cart-form
                                                data-id="product-actions-32473114" enctype="multipart/form-data">
                                                <div class="product-thumbnail">
                                                    <a class="image_thumb scale_hover"
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <h3 class="product-name"><a class="line-clamp line-clamp-2"
                                                            href="/man-hinh-iphone-14-pro-zin-chinh-hang"
                                                            title="Màn hình iPhone 14 Pro Zin Chính Hãng">Màn hình
                                                            iPhone 14 Pro Zin Chính Hãng</a></h3>
                                                    <div class="price-box">
                                                        7.700.000₫
                                        ...
                                        <div class="swiper-slide swiper-slide-pro">
                                            ...
                                            <form action="/cart/add" method="post"
                                                class="variants product-action" data-cart-form
                                                data-id="product-actions-32473132" enctype="multipart/form-data">
                                                <div class="product-thumbnail">
                                                    <a class="image_thumb scale_hover"
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <h3 class="product-name"><a class="line-clamp line-clamp-2"
                                                            href="/man-hinh-iphone-14-zin-chinh-hang"
                                                            title="Màn hình iPhone 14 Zin Chính Hãng">Màn hình iPhone
                                                            14 Zin Chính Hãng</a></h3>
                                                    <div class="price-box">
                                                        4.500.000₫
                                        ...
                                        <div class="swiper-slide swiper-slide-pro">
                                            ...
                                            <form action="/cart/add" method="post"
                                                class="variants product-action" data-cart-form
                                                data-id="product-actions-28542175" enctype="multipart/form-data">
                                                <div class="product-thumbnail">
                                                    <a class="image_thumb scale_hover"
                                        ...
                                        <div class="swiper-slide swiper-slide-pro">
                                            ...
                                            <form action="/cart/add" method="post"
                                                class="variants product-action" data-cart-form
                                                data-id="product-actions-28542185" enctype="multipart/form-data">
                                                <div class="product-thumbnail">
                                                    <a class="image_thumb scale_hover"
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <h3 class="product-name"><a class="line-clamp line-clamp-2"
                                                            href="/man-hinh-iphone-13-pro-zin-chinh-hang"
                                                            title="Màn hình iPhone 13 Pro Zin Chính Hãng">Màn hình
                                                            iPhone 13 Pro Zin Chính Hãng</a></h3>
                                                    <div class="price-box">
                                                        6.500.000₫
                                        ...
                                        <div class="swiper-slide swiper-slide-pro">
                                            ...
                                            <form action="/cart/add" method="post"
                                                class="variants product-action" data-cart-form
                                                data-id="product-actions-28542196" enctype="multipart/form-data">
                                                <div class="product-thumbnail">
                                                    <a class="image_thumb scale_hover"
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <h3 class="product-name"><a class="line-clamp line-clamp-2"
                                                            href="/man-hinh-iphone-13-zin-chinh-hang"
                                                            title="Màn hình iPhone 13 Zin Chính Hãng">Màn hình iPhone
                                                            13 Zin Chính Hãng</a></h3>
                                                    <div class="price-box">
                                                        3.500.000₫
                                        ...
                                        <div class="swiper-slide swiper-slide-pro">
                                            ...
                                            <form action="/cart/add" method="post"
                                                class="variants product-action" data-cart-form
                                                data-id="product-actions-28542160" enctype="multipart/form-data">
                                                <div class="product-thumbnail">
                                                    <a class="image_thumb scale_hover"
                                        ...
                                        <div class="swiper-slide swiper-slide-pro">
                                            ...
                                            <form action="/cart/add" method="post"
                                                class="variants product-action" data-cart-form
                                                data-id="product-actions-28542076" enctype="multipart/form-data">
                                                <div class="product-thumbnail">
                                                    <a class="image_thumb scale_hover"
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <h3 class="product-name"><a class="line-clamp line-clamp-2"
                                                            href="/man-hinh-iphone-12-pro-zin-chinh-hang"
                                                            title="Màn hình iPhone 12 Pro Zin Chính Hãng">Màn hình
                                                            iPhone 12 Pro Zin Chính Hãng</a></h3>
                                                    <div class="price-box">
                                                        2.900.000₫
                                        ...
                                        <div class="swiper-slide swiper-slide-pro">
                                            ...
                                            <form action="/cart/add" method="post"
                                                class="variants product-action" data-cart-form
                                                data-id="product-actions-28542110" enctype="multipart/form-data">
                                                <div class="product-thumbnail">
                                                    <a class="image_thumb scale_hover"
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <h3 class="product-name"><a class="line-clamp line-clamp-2"
                                                            href="/man-hinh-iphone-12-zin-chinh-hang"
                                                            title="Màn hình iPhone 12 Zin Chính Hãng">Màn hình iPhone
                                                            12 Zin Chính Hãng</a></h3>
                                                    <div class="price-box">
                                                        2.900.000₫
                                        ...
                                        <div class="swiper-slide swiper-slide-pro">
                                            ...
                                            <form action="/cart/add" method="post"
                                                class="variants product-action" data-cart-form
                                                data-id="product-actions-22421481" enctype="multipart/form-data">
                                                <div class="product-thumbnail">
                                                    <a class="image_thumb scale_hover"
            ...
            <section class="section_blog">
                <div class="container">
                    <div class="block-product block-background">
                                    ...
                                    <div class="block-content">
                                        ...
                                        <h3>
                                            <a class="line-clamp line-clamp-1"
                                                ...
                                                phát hành iOS 18.3.1 và iOS 17.7.5 khắc phục lỗ hổng bảo mật nghiêm
                                                trọng, mời bạn cập nhật ngay</a>
                                        </h3>
                                        <div class="time-post">
                                            Ngày đăng:
                                        ...
                                        <p class="justify line-clamp line-clamp-3">&nbsp;Apple&nbsp;đã bất ngờ tung ra
                                            iOS 18.3.1 cùng với iPadOS 18.3.1 và iOS 17.7.5 cho các thiết bị cũ hơn để
                                            vá lỗi bảo mật quan trọng.
                                            Trong một bài viết về bảo mật được đăng trên trang web của Apple, công ty đã
                                            nêu chi tiết các bản vá bảo...
                                        </p>
                            ...
                            <div class="col-md-6">
                                <div class="item-blog-small">
                                    ...
                                    <div class="block-content">
                                        ...
                                        <p class="justify line-clamp line-clamp-2">Sau 1 tuần chính thức phát hành,
                                            hãy cùng Sforum đánh giá IOS 18.3&nbsp;để xem bản cập nhật này có còn lỗi
                                            không và bạn có nên cập nhật trên điện thoại của mình không nhé.
                                    ...
                                    <div class="block-content">
                                        ...
                                        <h3>
                                            <a class="line-clamp line-clamp-2" style="    height: auto"
                                                ...
                                                đã cho phép chuyển ứng dụng đã mua từ tài khoản này sang tài khoản
                                                khác</a>
                                        </h3>

                                        <p class="justify line-clamp line-clamp-2">Nếu đang sở hữu hai tài khoản
                                            Apple&nbsp;với nhiều ứng dụng, nhạc, phim và các nội dung số khác thì chúc
                                            mừng bạn, Apple vừa ra mắt tính năng mới cho phép bạn hợp nhất các tài khoản
                                            bằng cách chuyển giao dịch mua hàng từ tài khoản này sang...
                                        </p>
                                ...
                                <div class="item-blog-small">
                                    ...
                                    <div class="block-content">
                                        ...
                                        <p class="justify line-clamp line-clamp-2">Apple mới đây đã chính thức khóa
                                            sign iOS 18.1.1, qua đó chặn người dùng iPhone&nbsp;chạy iOS 18.2 hạ cấp về
                                            phiên bản iOS này.
                                            “Nhà Táo” thường xuyên khóa sign các bản phát hành iOS cũ hơn theo thời gian
                                            để ngăn người dùng hạ cấp xuống phiên bản phần...
                                        </p>
                                    ...
                                    <div class="block-content">
                                        ...
                                        <h3>
                                            <a class="line-clamp line-clamp-2" style="    height: auto"
                                                ...
                                                phát hành bản thử nghiệm cuối cùng của iOS 18.2, bạn đã cập nhật
                                                chưa?</a>
                                        </h3>

                                        <p class="justify line-clamp line-clamp-2">Hôm nay, Apple&nbsp;đã phát hành
                                            các phiên bản Release Candidate của iOS 18.2, iPadOS 18.2 và macOS Sequoia
                                            15.2 sắp ra mắt cho các nhà phát triển và người tham gia chương trình public
                                            beta.
                        ...
                        <div class="text-center no-padding">
                            <a class="see-more" title="Xem toàn bộ tin tức" href="tin-tuc">Xem toàn bộ tin tức
            ...
            <section class="section_video">
                <div class="container ">
                    <div class="block-product block-background">
                        <h3 class="title-index p-5">
                            <a class="title-name" href="huong-dan-thu-thuat" title="Hướng Dẫn Thủ Thuật">Hướng Dẫn
                                Thủ Thuật
                            </a>
                        ...
                        <div class="text-center no-padding">
                            <a class="see-more" title="Xem toàn bộ video" href="huong-dan-thu-thuat">Xem toàn bộ
                                video <svg xmlns="http://www.w3.org/2000/svg" height="1em"
                                    viewBox="0 0 448 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                    <path
                                        d="M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z" />
                                </svg></a>
        ...
        <link rel="preload" as="script"
            href="//bizweb.dktcdn.net/100/112/815/themes/966034/assets/index.js?1741067950025" />
        <script src="//bizweb.dktcdn.net/100/112/815/themes/966034/assets/index.js?1741067950025" type="text/javascript">
        </script>
        <link rel="preload" as="script"
