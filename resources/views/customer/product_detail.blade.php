                        ...
                        <div class="product-image-block">
                            <div
                                ...
                                <div class="swiper-wrapper" id="lightgallery" style="transition-duration: 0ms;">
                                    <a class="swiper-slide product_videobox" href="{{ asset($product->image) }}"
                                        style="width: 343px; opacity: 1;">
                                        <img height="400" width="400" src="{{ asset($product->image) }}"
                                            alt="{{ $product->name }}"
                            ...
                            <form enctype="multipart/form-data" data-cart-form="" id="add-to-cart-form"
                                            ...
                                            <div class="thump-swatch">
                                                @foreach ($colors as $colorGroup)
                                                    <div data-value="{{ $colorGroup['color'] }}"
                                                        ...
                                                        <div class="tooltip"
                                                            style="background-color: {{ $colorGroup['variants']->first()->color_hex_code ?? '' }};">
                                                            {{ $colorGroup['color'] }}
                                                        </div>
                                ...
                                <script>
                                    ...
                                    jQuery('.color-selector').on('change', function() {
                                        ...
                                        var newUrl = '/customer/product_detail/' + productId + '?storage=' + selectedStorage + '&color=' +
                                            selectedColor;
                                ...
                                <div class="flex-quantity">
                                    ...
                                    <form id="productForm" method="POST">
                                        ...
                                        <div class="group-button">
                                            <button type="button" class="btn-buyNow" id="buyNow"
                                                onclick="submitForm('{{ route('customer.buynow') }}')">
                                                Mua ngay
                                            </button>
                                            <button type="button" class="btn-buyNow bg-danger" id="addToCart"
                                                onclick="submitForm('{{ route('customer.postCart') }}')">
                                                Thêm vào giỏ hàng
                                            </button>
                                        </div>
                                    </form>
                                    <script>
                                        document.addEventListener("DOMContentLoaded", function() {
                                            ...
                                            function updateHiddenInputs() {
                                                ...
                                                selectedStorageInput.value = selectedStorage;
                                            }

                                            function checkStock() {
                                                if (!selectedColor || !selectedStorage) return;

                                                fetch(`/api/check-stock?product_id={{ $product->id }}&color=${selectedColor}&storage=${selectedStorage}`)
                                                    .then(response => response.json())
                                                    .then(data => {
                                                        const stockStatus = document.getElementById("stock-status");
                                                        const actionButtons = document.querySelector(".group-button");
                                                        const productPrice = document.getElementById("display-price");
                                                        const productOriginPrice = document.getElementById("display-origin-price");
                                                        ...
                                                        if (data.in_stock) {
                                                            ...
                                                            productPrice.textContent = new Intl.NumberFormat().format(data.price) + "₫";
                                                            productOriginPrice.textContent = new Intl.NumberFormat().format(data.origin_price) + "₫";
                                                        } else {
                                            ...
                                            colorButtons.forEach(button => {
                                                button.addEventListener("click", function() {
                                                    ...
                                                    colorButtons.forEach(btn => btn.classList.remove("btn-primary"));
                                            ...
                                            storageButtons.forEach(button => {
                                                button.addEventListener("click", function() {
                                                    ...
                                                    storageButtons.forEach(btn => btn.classList.remove("btn-primary"));
                                                    this.classList.add("btn-primary");
                                                    updateHiddenInputs();
                                                    checkStock();
                                                });
                            ...
                            <div class="col-12 col-md-12 col-lg-4 col-xl-12">
                                <div class="product-hethong">
                                    ...
                                    <div class="info-store info-block">
                                        <div data-local="Hà Nội" data-district="Quận Đống Đa" class="store-list">
                                            <span class="name-cuahang">Hoàng Kiên Xã Đàn</span><span
                                                class="store-name"><b>Địa chỉ:</b> 284 Xã Đàn, Đống Đa, Hà Nội:
                                                083.888.3663</span></div>
                                        <div data-local="Hà Nội" data-district="Quận Long Biên" class="store-list">
                                            <span class="name-cuahang">Hoàng Kiên Hồng Tiến</span><span
                                                class="store-name"><b>Địa chỉ:</b> 48 Hồnng Tiến, Q. Long Biên, Hà Nội:
                                                090.896.3993</span></div>
                                        <div data-local="Hà Nội" data-district="Quận Hà Đông" class="store-list">
                                            <span class="name-cuahang">Hoàng Kiên Trần Phú</span><span
                                                class="store-name"><b>Địa chỉ:</b> 42 Trần Phú, Q. Hà Đông, Hà Nội:
                                                086.888.3663</span></div>
                                        <div data-local="Hồ Chí Minh" data-district="Quận 10" class="store-list">
                                            <span class="name-cuahang">Hoàng Kiên Ngô Gia Tự</span><span
                                                class="store-name"><b>Địa chỉ:</b> 403 Ngô Gia Tự- P.2, Q.10 Hồ Chí
                                                Minh: 0707.678.707</span></div>
                                    </div>
                                </div>
                            </div>
                            <script>
                                $(document).ready(function() {
                                    var public_spreadsheet_url =
                                        "https://docs.google.com/spreadsheets/d/e/2PACX-1vRIgXK-Wn8Uzhfto2jPCMlzuYspNv1ylRbGnQYIRAz52eOlpsWVBOiUHtGsG4x5jA0gjQGwdACLSk7D/pub?output=csv";
                                    var data;
                                            ...
                                            function showlocation(local) {
                                                ...
                                                dataFix.forEach(function(data) {
                                                    ...
                                                    cityString += '<div data-local="' + data.city +
                                                        ...
                                                        '<span class="store-name"><b>Địa chỉ:</b> ' + data.address +
                                                        '</span>' +
                                                        '</div>	';
                                                })
                                ...
                                <div class="content">
                                    <ul>
                                        <li><img width="20" height="20"
                                                src="//bizweb.dktcdn.net/100/112/815/themes/966034/assets/camket_1.png?1742954225872"
                                                alt="Bảo hành 12 tháng lỗi 1 đổi 1">
                                            Bảo hành 12 tháng lỗi 1 đổi 1
                                        </li>
                                        <li><img width="20" height="20"
                                                src="//bizweb.dktcdn.net/100/112/815/themes/966034/assets/camket_2.png?1742954225872"
                                                alt="Cam kết không Zin tặng máy">
                                            Cam kết không Zin tặng máy
                                        </li>
                                        <li><img width="20" height="20"
                                                src="//bizweb.dktcdn.net/100/112/815/themes/966034/assets/camket_3.png?1742954225872"
                                                alt="Lên đời thu 100% giá web">
                                            Lên đời thu 100% giá web
                                        </li>
                                        <li><img width="20" height="20"
                                                src="//bizweb.dktcdn.net/100/112/815/themes/966034/assets/camket_4.png?1742954225872"
                                                alt="Bảo hành rơi vỡ vào nước sửa chữa miễn phí không giới hạn">
                                            Bảo hành rơi vỡ vào nước sửa chữa miễn phí không giới hạn
                                        </li>
                                        <li><img width="20" height="20"
                                                src="//bizweb.dktcdn.net/100/112/815/themes/966034/assets/camket_5.png?1742954225872"
                                                alt="Reset bảo hành chỉ 500K">
                                            Reset bảo hành chỉ 500K
                                        </li>
                                        <li><img width="20" height="20"
                                                src="//bizweb.dktcdn.net/100/112/815/themes/966034/assets/camket_6.png?1742954225872"
                                                alt="Tặng kèm cáp sạc nhanh zin + Cường lực full màn + ốp silicon chống sốc">
                        ...
                        <div class="col-12 col-md-6 col-lg-4 col-xl-12">
                            <div class="khuyen-mai">
                                ...
                                <div class="content">
                                    <ul>
                                        <li><img width="20" height="20"
                                                src="//bizweb.dktcdn.net/100/112/815/themes/966034/assets/km_product1.png?1742954225872"
                                                alt="Máy thanh lý là các máy trade-in bán hộ hoặc đã qua sửa chữa. Vui lòng liên hệ để biết thêm chi tiết.">Máy
                                            thanh lý là các máy trade-in bán hộ hoặc đã qua sửa chữa. Vui lòng liên hệ
                                            để biết thêm chi tiết.</li>
                                        <li><img width="20" height="20"
                                                src="//bizweb.dktcdn.net/100/112/815/themes/966034/assets/km_product2.png?1742954225872"
                                                alt="Máy 99% là các máy gần như mới, có vài vết xước nhẹ nhỏ">Máy 99%
                                            là các máy gần như mới, có vài vết xước nhẹ nhỏ</li>
                                        <li><img width="20" height="20"
                                                src="//bizweb.dktcdn.net/100/112/815/themes/966034/assets/km_product3.png?1742954225872"
                                                alt="Máy New 100% là các máy mới chưa Active ( không box )">Máy New
                                            100% là các máy mới chưa Active ( không box )</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="product-like block-background">
                            ...
                            <div class="product1-swiper swiper-container p-5 swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events swiper-container-multirow"
                                ...
                                <div class="swiper-wrapper"
                                    style="width: 666px; transform: translate3d(0px, 0px, 0px);">
                                    <div class="swiper-slide swiper-slide-active"
                                        style="width: 202px; margin-right: 20px;">
                                        <form action="/cart/add" method="post" class="variants product-action"
                                            data-cart-form="" data-id="product-actions-38020522"
                                            enctype="multipart/form-data">
                                            <div class="product-thumbnail">
                                                <a class="image_thumb scale_hover" href="/iphone-13-pro-max-128gb"
                                            ...
                                            <div class="product-info">
                                                <h3 class="product-name"><a class="line-clamp line-clamp-2"
                                                        ...
                                                        title="iPhone 13 Pro Max 128GB">iPhone 13 Pro Max 128GB</a>
                                                </h3>
                                                <div class="price-box">
                                                    13.100.000₫
                                                </div>
                                    ...
                                    <div class="swiper-slide swiper-slide-next"
                                        style="width: 202px; margin-right: 20px;">
                                        <form action="/cart/add" method="post" class="variants product-action"
                                            data-cart-form="" data-id="product-actions-38020526"
                                            enctype="multipart/form-data">
                                            <div class="product-thumbnail">
                                            ...
                                            <div class="product-info">
                                                <h3 class="product-name"><a class="line-clamp line-clamp-2"
                                                        ...
                                                        title="iPhone 13 Pro Max 256GB">iPhone 13 Pro Max 256GB</a>
                                                </h3>
                                                <div class="price-box">
                                                    14.100.000₫
                                                </div>
                                    ...
                                    <div class="swiper-slide" style="width: 202px; margin-right: 20px;">
                                        <form action="/cart/add" method="post" class="variants product-action"
                                            data-cart-form="" data-id="product-actions-38020529"
                                            enctype="multipart/form-data">
                                            <div class="product-thumbnail">
                                                <a class="image_thumb scale_hover" href="/iphone-13-pro-max-512gb"
                                            ...
                                            <div class="product-info">
                                                <h3 class="product-name"><a class="line-clamp line-clamp-2"
                                                        ...
                                                        title="iPhone 13 Pro Max 512GB">iPhone 13 Pro Max 512GB</a>
                                                </h3>
                                                <div class="price-box">
                                                    14.900.000₫
                                                </div>
                                    ...
                                    <div class="swiper-slide"
                                        style="margin-top: 20px; width: 202px; margin-right: 20px;">
                                        <form action="/cart/add" method="post" class="variants product-action"
                                            data-cart-form="" data-id="product-actions-38020533"
                                            enctype="multipart/form-data">
                                            <div class="product-thumbnail">
                                            ...
                                            <div class="product-info">
                                                <h3 class="product-name"><a class="line-clamp line-clamp-2"
                                                        href="/iphone-13-pro-max-1thone-13-pro-max-1tb"
                                                        title="iPhone 13 Pro Max 1TB">iPhone 13 Pro Max 1TB</a></h3>
                                                <div class="price-box">
                                                    15.400.000₫
                                                </div>
                                                <div class="wishlish-compare">
                                    ...
                                    <div class="swiper-slide"
                                        style="margin-top: 20px; width: 202px; margin-right: 20px;">
                                        <form action="/cart/add" method="post" class="variants product-action"
                                            data-cart-form="" data-id="product-actions-38020576"
                                            enctype="multipart/form-data">
                                            <div class="product-thumbnail">
                                            ...
                                            <div class="product-info">
                                                <h3 class="product-name"><a class="line-clamp line-clamp-2"
                                                        href="/iphone-13-pro-128gb" title="iPhone 13 Pro 128GB">iPhone
                                                        13 Pro 128GB</a></h3>
                                                <div class="price-box">
                                                    11.400.000₫
                                                </div>
                            ...
                            <div class="text-center no-padding">
                                <a class="see-more" title="Xem toàn bộ sản phẩm" href="iphone-13-13pro-13pro-max">Xem
        ...
        <div class="block-product block-background">
            ...
            <div
                ...
                <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
                    <div class="swiper-slide swiper-slide-pro swiper-slide-active"
                        style="width: 202px; margin-right: 20px;">
                        <form action="/cart/add" method="post" class="variants product-action" data-cart-form=""
                            ...
                            <div class="product-thumbnail">
                                <a class="image_thumb scale_hover" href="/iphone-16-pro-max-256gb"
                                    ...
                                    <img width="234" height="234" class="lazyload image1 loaded"
                                        src="//bizweb.dktcdn.net/thumb/large/100/112/815/products/16prm-full-da134920-b18f-41e8-a5c9-50312d7d0e9d-b975b0aa-7752-49b5-abab-233be70b7b70.png?v=1730447628487"
                                        ...
                                        alt="iPhone 16 Pro Max 256GB" data-was-processed="true">
                                </a>
                                <div class="tag-km">
                                </div>
                            ...
                            <div class="product-info">
                                <h3 class="product-name"><a class="line-clamp line-clamp-2"
                                        href="/iphone-16-pro-max-256gb" title="iPhone 16 Pro Max 256GB">iPhone 16 Pro
                                        Max 256GB</a></h3>
                                <div class="price-box">
                                    23.900.000₫
                                </div>
                    ...
                    <div class="swiper-slide swiper-slide-pro swiper-slide-next"
                        style="width: 202px; margin-right: 20px;">
                        <form action="/cart/add" method="post" class="variants product-action" data-cart-form=""
                            data-id="product-actions-42560501" enctype="multipart/form-data">
                            <div class="product-thumbnail">
                                <a class="image_thumb scale_hover" href="/iphone-16-pro-max-1t"
                                    title="iPhone 16 Pro Max 1T">
                                    <img width="234" height="234" class="lazyload image1 loaded"
                                        src="//bizweb.dktcdn.net/thumb/large/100/112/815/products/16prm-full-da134920-b18f-41e8-a5c9-50312d7d0e9d-a373a501-a879-49b7-8036-024e2dead860-aee81e09-fab2-4a9b-95df-1e579811284b.png?v=1742563225820"
                                        data-src="//bizweb.dktcdn.net/thumb/large/100/112/815/products/16prm-full-da134920-b18f-41e8-a5c9-50312d7d0e9d-a373a501-a879-49b7-8036-024e2dead860-aee81e09-fab2-4a9b-95df-1e579811284b.png?v=1742563225820"
                                        alt="iPhone 16 Pro Max 1T" data-was-processed="true">
                                </a>
                                <div class="tag-km">
                                </div>
                                ...
                                <div class="action">
                                    <button class="btn-cart btn-views" title="Xem chi tiết" type="button"
                                        onclick="window.location.href='/iphone-16-pro-max-1t'">
                                        <svg class="icon">
                                            <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-detail">
                                            </use>
                                        </svg>
                            ...
                            <div class="product-info">
                                <h3 class="product-name"><a class="line-clamp line-clamp-2"
                                        href="/iphone-16-pro-max-1t" title="iPhone 16 Pro Max 1T">iPhone 16 Pro Max
                                        1T</a></h3>
                                <div class="price-box">
                                    31.000.000₫
                                </div>
            ...
            <div class="text-center no-padding">
                <a class="see-more" title="Xem toàn bộ sản phẩm" href="/iphone-16-pro-max">Xem toàn bộ sản phẩm <svg
