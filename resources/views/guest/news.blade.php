...
<div class="bodywrap">
  ...
  <div class="latest-news-card">
    <div class="latest-news-image">
      <a href="{{ route('guest.show', $news->id) }}">
    ...
    <div class="latest-news-content">
      <h3>
        <a href="{{ route('guest.show', $news->id) }}">{{ $news->title }}</a>
      </h3>
      <div class="meta-row">
          ...
          <div class="aside-content-blog">
            ...
            <div class="nav-category">
              <ul>
                ...
                <li><a href="{{ route('guest.warranty') }}">Chính sách bảo hành</a></li>
                <li><a href="{{ route('guest.contact') }}">Liên hê</a></li>
                <li><a href="#"></a></li>
              </ul>
            </div>
          </div>
  ...
  <div class="highlight-news-list">
    ...
    <div class="highlight-item">
      ...
      <div class="highlight-thumb">
        <a href="{{ route('guest.show', $highlight->id) }}">
      ...
      <div class="highlight-info">
        <a class="title" href="{{ route('guest.show', $highlight->id) }}">{{ Str::limit($highlight->title, 50) }}</a>
