...
<div class="container my-4">
    ...
    <div class="container">
        ...
        <div class="filter">
            ...
            <form action="{{ route('guest.filter', $category->id) }}" method="GET" style="display: flex;">
                <div class="mb-3 me-4">
            ...
            @else
                @foreach ($products as $product)
                    <div class="col-6 col-md-4 col-lg-3 mb-4 p-2" style="width: 20%;">
                        <form action="{{ route('customercustomer.postCart') }}" method="post" class="variants product-action"
                            ...
                            <div class="product-thumbnail">
                                ...
                                <div class="action">
                                    <a href="{{ route('guest.product_detail', $product->id) }}" class="btn-views"
                                        title="Xem chi tiết">
